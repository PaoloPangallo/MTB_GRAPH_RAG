"""La rigenerazione degli artefatti dell'audit 1.3, contro il gold.
...
Stava in `backend/tests/test_pre_promotion_audit_1_3.py`, dove si dichiarava saltato quando il bundle
...
from backend.tests import test_pre_promotion_audit_1_3 as CORE
