"""La chiusura delle fonti non-terapeutiche, dove apre la cache degli abstract.

La cache e' testo protetto da copyright: e' esclusa dal versionamento da
.gitignore, non per dimenticanza. Questi test la aprono davvero, e stanno fuori
dalla discovery della suite core per questo.
"""
