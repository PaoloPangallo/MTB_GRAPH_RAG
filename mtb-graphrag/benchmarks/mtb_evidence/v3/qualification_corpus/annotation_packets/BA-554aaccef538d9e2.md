# Annotazione BA-554aaccef538d9e2

## Fonte

- **Titolo:** Prospective Evaluation of First-Line Erlotinib in Advanced Non-Small Cell Lung Cancer (NSCLC) Carrying an Activating EGFR Mutation: A Multicenter Academic Phase II Study in Caucasian Patients (FIELT).
- **PMID:** 27032107
- **DOI:** —
- **NCT:** —
- **Rivista:** PloS one
- **Anno:** 2016
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/27032107/

## Proposizioni candidate

| statement | malattia | biomarcatore | intervento | direzione |
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-4290` | Lung Adenocarcinoma | EGFR L858R | erlotinib | sensitivity |
