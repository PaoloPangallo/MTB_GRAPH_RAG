# Annotazione BA-d6890c470c9709a8
...
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-3791` | Lung Adenocarcinoma | EGFR L858R OR EGFR Exon 19 Deletion | erlotinib | sensitivity |
| `ES-V2-evidence-885` | Lung Non-small Cell Carcinoma | EGFR L858R | erlotinib | sensitivity |
...
- possibili coorti multiple: 2 denominazioni di malattia distinte
