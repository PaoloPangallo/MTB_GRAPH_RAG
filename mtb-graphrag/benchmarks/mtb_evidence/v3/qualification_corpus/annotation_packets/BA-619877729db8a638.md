# Annotazione BA-619877729db8a638

## Fonte

- **Titolo:** EGFR-RAD51 gene fusion NSCLC responsiveness to different generation EGFR-TKIs: two cases and review of the literature.
- **PMID:** 35399574
- **DOI:** —
- **NCT:** —
- **Rivista:** Translational lung cancer research
- **Anno:** 2022
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/35399574/

## Proposizioni candidate

| statement | malattia | biomarcatore | intervento | direzione |
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-12370` | Lung Adenocarcinoma | EGFR::RAD51 Fusion | osimertinib | sensitivity |
