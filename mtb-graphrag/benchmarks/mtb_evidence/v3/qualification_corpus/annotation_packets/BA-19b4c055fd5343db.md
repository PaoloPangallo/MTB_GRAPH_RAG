# Annotazione BA-19b4c055fd5343db

## Fonte

- **Titolo:** Acquired EGFR C797S mutation mediates resistance to AZD9291 in non-small cell lung cancer harboring EGFR T790M.
- **PMID:** 25939061
- **DOI:** —
- **NCT:** —
- **Rivista:** Nature medicine
- **Anno:** 2015
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/25939061/

## Proposizioni candidate

| statement | malattia | biomarcatore | intervento | direzione |
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-964` | Lung Non-small Cell Carcinoma | EGFR C797S | osimertinib | resistance |
