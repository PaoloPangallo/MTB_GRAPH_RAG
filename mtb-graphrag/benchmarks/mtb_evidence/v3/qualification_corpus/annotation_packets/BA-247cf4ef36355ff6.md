# Annotazione BA-247cf4ef36355ff6

## Fonte

- **Titolo:** Ramucirumab plus erlotinib in patients with untreated, EGFR-mutated, advanced non-small-cell lung cancer (RELAY): a randomised, double-blind, placebo-controlled, phase 3 trial.
- **PMID:** 31591063
- **DOI:** —
- **NCT:** —
- **Rivista:** The Lancet. Oncology
- **Anno:** 2019
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/31591063/

## Proposizioni candidate

| statement | malattia | biomarcatore | intervento | direzione |
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-11240` | Lung Non-small Cell Carcinoma | EGFR L858R OR EGFR Exon 19 Deletion | erlotinib | sensitivity |
