# Annotazione BA-e6d9396b071126d9
...
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-2626` | Lung Non-small Cell Carcinoma | EGFR L858R | lapatinib | sensitivity |
| `ES-V2-evidence-2629` | Lung Non-small Cell Carcinoma | EGFR L858R | afatinib | sensitivity |
| `ES-V2-evidence-2631` | Lung Non-small Cell Carcinoma | EGFR L858R | canertinib | sensitivity |
| `ES-V2-evidence-4284` | Lung Non-small Cell Carcinoma | EGFR L858R | erlotinib | sensitivity |
...
- possibili coorti multiple: 4 interventi distinti negli statement
