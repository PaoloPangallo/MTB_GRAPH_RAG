# Annotazione BA-adda377cae193371

## Fonte

- **Titolo:** Specific EGFR mutations predict treatment outcome of stage IIIB/IV patients with chemotherapy-naive non-small-cell lung cancer receiving first-line gefitinib monotherapy.
- **PMID:** 18509184
- **DOI:** —
- **NCT:** —
- **Rivista:** Journal of clinical oncology : official journal of the American Society of Clinical Oncology
- **Anno:** 2008
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/18509184/

## Proposizioni candidate

| statement | malattia | biomarcatore | intervento | direzione |
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-1665` | Lung Non-small Cell Carcinoma | EGFR L858R | gefitinib | sensitivity |
