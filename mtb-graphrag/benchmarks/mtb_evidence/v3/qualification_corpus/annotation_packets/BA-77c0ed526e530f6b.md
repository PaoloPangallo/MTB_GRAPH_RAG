# Annotazione BA-77c0ed526e530f6b

## Fonte

- **Titolo:** Differential protein stability of EGFR mutants determines responsiveness to tyrosine kinase inhibitors.
- **PMID:** 27612423
- **DOI:** —
- **NCT:** —
- **Rivista:** Oncotarget
- **Anno:** 2016
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/27612423/

## Proposizioni candidate

| statement | malattia | biomarcatore | intervento | direzione |
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-4287` | Lung Non-small Cell Carcinoma | EGFR L858R | erlotinib | sensitivity |
