# Annotazione BA-9f6c3e46b038a39b

## Fonte

- **Titolo:** The neuroblastoma-associated F1174L ALK mutation causes resistance to an ALK kinase inhibitor in ALK-translocated cancers.
- **PMID:** 21030459
- **DOI:** —
- **NCT:** —
- **Rivista:** Cancer research
- **Anno:** 2010
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/21030459/

## Proposizioni candidate

| statement | malattia | biomarcatore | intervento | direzione |
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-32` | Inflammatory Myofibroblastic Tumor | ALK F1174L | crizotinib | resistance |
| `ES-V2-evidence-33` | Lung Non-small Cell Carcinoma | ALK F1174L | crizotinib | resistance |
