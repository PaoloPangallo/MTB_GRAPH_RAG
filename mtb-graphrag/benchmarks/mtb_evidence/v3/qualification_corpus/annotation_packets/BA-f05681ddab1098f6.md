# Annotazione BA-f05681ddab1098f6

## Fonte

- **Titolo:** Infigratinib (BGJ398) in previously treated patients with advanced or metastatic cholangiocarcinoma with FGFR2 fusions or rearrangements: mature results from a multicentre, open-label, single-arm, phase 2 study.
- **PMID:** 34358484
- **DOI:** —
- **NCT:** —
- **Rivista:** The lancet. Gastroenterology & hepatology
- **Anno:** 2021
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/34358484/

## Proposizioni candidate

| statement | malattia | biomarcatore | intervento | direzione |
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-11230` | Cholangiocarcinoma | FGFR2::v Fusion OR FGFR2::? Fusion | infigratinib | sensitivity |
