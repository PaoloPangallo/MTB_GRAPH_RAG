# Annotazione BA-9da28cce330d3f37

## Fonte

- **Titolo:** Molecular predictors of outcome with gefitinib and docetaxel in previously treated non-small-cell lung cancer: data from the randomized phase III INTEREST trial.
- **PMID:** 20038723
- **DOI:** —
- **NCT:** —
- **Rivista:** Journal of clinical oncology : official journal of the American Society of Clinical Oncology
- **Anno:** 2010
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/20038723/

## Proposizioni candidate

| statement | malattia | biomarcatore | intervento | direzione |
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-2621` | Lung Non-small Cell Carcinoma | EGFR L858R | gefitinib | sensitivity |
