# Annotazione BA-8e1f7289dd471bbf

## Fonte

- **Titolo:** A novel ALK secondary mutation and EGFR signaling cause resistance to ALK kinase inhibitors.
- **PMID:** 21791641
- **DOI:** —
- **NCT:** —
- **Rivista:** Cancer research
- **Anno:** 2011
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/21791641/

## Proposizioni candidate

| statement | malattia | biomarcatore | intervento | direzione |
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-763` | Lung Non-small Cell Carcinoma | EML4::ALK Fusion AND ALK L1152R | crizotinib | resistance |
