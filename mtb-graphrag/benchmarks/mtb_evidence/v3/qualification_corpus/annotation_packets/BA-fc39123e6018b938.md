# Annotazione BA-fc39123e6018b938

## Fonte

- **Titolo:** Non-small-cell lung cancer and Ba/F3 transformed cells harboring the ERBB2 G776insV_G/C mutation are sensitive to the dual-specific epidermal growth factor receptor and ERBB2 inhibitor HKI-272.
- **PMID:** 16818618
- **DOI:** —
- **NCT:** —
- **Rivista:** Cancer research
- **Anno:** 2006
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/16818618/

## Proposizioni candidate

| statement | malattia | biomarcatore | intervento | direzione |
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-2628` | Lung Non-small Cell Carcinoma | EGFR L858R | neratinib maleate | sensitivity |
