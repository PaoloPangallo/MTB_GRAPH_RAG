# Annotazione BA-f023905d8be6ddd2

## Fonte

- **Titolo:** Functional analysis of cancer-associated EGFR mutants using a cellular assay with YFP-tagged EGFR intracellular domain.
- **PMID:** 17877814
- **DOI:** —
- **NCT:** —
- **Rivista:** Molecular cancer
- **Anno:** 2007
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/17877814/

## Proposizioni candidate

| statement | malattia | biomarcatore | intervento | direzione |
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-4265` | Cancer | EGFR L858R | erlotinib | sensitivity |
