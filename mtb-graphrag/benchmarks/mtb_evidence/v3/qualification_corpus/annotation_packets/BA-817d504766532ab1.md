# Annotazione BA-817d504766532ab1

## Fonte

- **Titolo:** Afatinib versus cisplatin plus gemcitabine for first-line treatment of Asian patients with advanced non-small-cell lung cancer harbouring EGFR mutations (LUX-Lung 6): an open-label, randomised phase 3 trial.
- **PMID:** 24439929
- **DOI:** —
- **NCT:** —
- **Rivista:** The Lancet. Oncology
- **Anno:** 2014
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/24439929/

## Proposizioni candidate

| statement | malattia | biomarcatore | intervento | direzione |
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-982` | Lung Adenocarcinoma | EGFR L858R | afatinib | sensitivity |
