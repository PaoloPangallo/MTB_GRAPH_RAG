# Annotazione BA-64317ec1c6d9a333

## Fonte

- **Titolo:** A novel acquired ALK F1245C mutation confers resistance to crizotinib in ALK-positive NSCLC but is sensitive to ceritinib.
- **PMID:** 26775591
- **DOI:** —
- **NCT:** —
- **Rivista:** Lung cancer (Amsterdam, Netherlands)
- **Anno:** 2016
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/26775591/

## Proposizioni candidate

| statement | malattia | biomarcatore | intervento | direzione |
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-1339` | Lung Non-small Cell Carcinoma | EML4::ALK Fusion AND ALK F1245C | crizotinib | resistance |
