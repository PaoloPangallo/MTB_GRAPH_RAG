# Annotazione BA-def1bce0dbbbe037

## Fonte

- **Titolo:** Relationship between EGFR expression, EGFR mutation status, and the efficacy of chemotherapy plus cetuximab in FLEX study patients with advanced non-small-cell lung cancer.
- **PMID:** 24662454
- **DOI:** —
- **NCT:** —
- **Rivista:** Journal of thoracic oncology : official publication of the International Association for the Study of Lung Cancer
- **Anno:** 2014
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/24662454/

## Proposizioni candidate

| statement | malattia | biomarcatore | intervento | direzione |
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-347` | Lung Non-small Cell Carcinoma | EGFR L858R |  | prognostic |
