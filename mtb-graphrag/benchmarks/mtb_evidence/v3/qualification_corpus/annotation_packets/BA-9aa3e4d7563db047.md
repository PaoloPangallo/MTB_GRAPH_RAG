# Annotazione BA-9aa3e4d7563db047

## Fonte

- **Titolo:** PF00299804, an irreversible pan-ERBB inhibitor, is effective in lung cancer models with EGFR and ERBB2 mutations that are resistant to gefitinib.
- **PMID:** 18089823
- **DOI:** —
- **NCT:** —
- **Rivista:** Cancer research
- **Anno:** 2007
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/18089823/

## Proposizioni candidate

| statement | malattia | biomarcatore | intervento | direzione |
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-2627` | Lung Non-small Cell Carcinoma | EGFR L858R | dacomitinib | sensitivity |
