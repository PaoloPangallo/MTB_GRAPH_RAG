# Annotazione BA-2fd54dcc3a31ea1e

## Fonte

- **Titolo:** Epidermal growth factor receptor activation in glioblastoma through novel missense mutations in the extracellular domain.
- **PMID:** 17177598
- **DOI:** —
- **NCT:** —
- **Rivista:** PLoS medicine
- **Anno:** 2006
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/17177598/

## Proposizioni candidate

| statement | malattia | biomarcatore | intervento | direzione |
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-4295` | High Grade Glioma | EGFR L858R | erlotinib | sensitivity |
