# Annotazione BA-4af66a22ec088e48

## Fonte

- **Titolo:** An Acquired HER2(T798I) Gatekeeper Mutation Induces Resistance to Neratinib in a Patient with HER2 Mutant-Driven Breast Cancer.
- **PMID:** 28274957
- **DOI:** —
- **NCT:** —
- **Rivista:** Cancer discovery
- **Anno:** 2017
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/28274957/

## Proposizioni candidate

| statement | malattia | biomarcatore | intervento | direzione |
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-6174` | Breast Cancer | ERBB2 T798I | osimertinib | sensitivity |
