# Annotazione BA-f0ceef3ff0fbe03d

## Fonte

- **Titolo:** U.S. Food and Drug Administration approval summary: Erlotinib for the first-line treatment of metastatic non-small cell lung cancer with epidermal growth factor receptor exon 19 deletions or exon 21 (L858R) substitution mutations.
- **PMID:** 24868098
- **DOI:** —
- **NCT:** —
- **Rivista:** The oncologist
- **Anno:** 2014
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/24868098/

## Proposizioni candidate

| statement | malattia | biomarcatore | intervento | direzione |
| --- | --- | --- | --- | --- |
| `ES-V2-evidence-2994` | Lung Non-small Cell Carcinoma | EGFR L858R | erlotinib | sensitivity |
