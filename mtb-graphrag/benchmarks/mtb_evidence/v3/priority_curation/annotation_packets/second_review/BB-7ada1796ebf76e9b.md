# Revisione BB-7ada1796ebf76e9b — second_review
...
- **Tipi di pubblicazione:** Clinical Trial, Phase I, Journal Article, Multicenter Study, Research Support, Non-U.S. Gov't
...
| --- | --- | --- | --- |
| `ES-V2-evidence-1917` | erdafitinib | `candidate_not_determinable` | `unsupported_by_primary_source` |
| `ES-V2-evidence-1918` | erdafitinib | `candidate_not_determinable` | `unsupported_by_primary_source` |
| `ES-V2-evidence-1920` | erdafitinib | `candidate_not_determinable` | `unsupported_by_primary_source` |
| `ES-V2-evidence-4861` | erdafitinib | `candidate_not_determinable` | `unsupported_by_primary_source` |

## Rilevazioni automatiche

**Emesse come valore:**

- `evidence_design` = `clinical_trial_phase_2` — «phase II» (PURPOSE)

**Rilevate ma NON emesse — da verificare sulla fonte:**

- `setting` ⇒ `advanced`? — «advanced» (PATIENTS AND METHODS)
...
- **PURPOSE** — «…first-in-human study evaluates the safety, pharmacokinetics, and pharmacodynamics and defines the recommended phase II dose (RP2D) of JNJ-42756493.»
- **PATIENTS AND METHODS** — «Eligible patients with advanced solid tumors received escalating doses of JNJ-42756493 from 0.5 to 12 mg administered continuously daily or J…»
