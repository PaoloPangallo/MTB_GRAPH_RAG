# Revisione BB-a2c389c10e9cad57 — second_review

## Fonte

- **Titolo:** BIBW2992, an irreversible EGFR/HER2 inhibitor highly effective in preclinical lung cancer models.
- **PMID:** 18408761
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/18408761/
...
| --- | --- | --- | --- |
| `ES-V2-evidence-2626` | lapatinib | `candidate_not_determinable` | `unsupported_by_primary_source` |
| `ES-V2-evidence-2629` | afatinib | `candidate_not_determinable` | `unsupported_by_primary_source` |
| `ES-V2-evidence-2631` | canertinib | `candidate_not_determinable` | `unsupported_by_primary_source` |
| `ES-V2-evidence-4284` | erlotinib | `candidate_valid` | `direct_support` |
...
- **UNLABELLED** — «…this activity, BIBW2992 suppresses transformation in isogenic cell-based assays, inhibits survival of cancer cell lines and induces tumor regression in xenograft and transgenic lung cancer models, with superior activity over erlo…»
- **UNLABELLED** — «…rmation in isogenic cell-based assays, inhibits survival of cancer cell lines and induces tumor regression in xenograft and transgenic lung cancer models, with superior activity over erlotinib. These findings encourage further te…»
