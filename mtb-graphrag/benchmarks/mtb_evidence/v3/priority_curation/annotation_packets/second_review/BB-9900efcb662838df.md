# Revisione BB-9900efcb662838df — second_review
...
| --- | --- | --- | --- |
| `ES-V2-evidence-11114` | lorlatinib | `candidate_valid` | `direct_support` |
| `ES-V2-evidence-11115` | alectinib hydrochloride | `candidate_not_determinable` | `unsupported_by_primary_source` |

## Rilevazioni automatiche

**Emesse come valore:**

- `evidence_design` = `case_report` — «case report» (UNLABELLED)

**Rilevate ma NON emesse — da verificare sulla fonte:**

- `stage` ⇒ `stage III`? — «stage IIIB» (UNLABELLED)
- `therapy_line` ⇒ `first line`? — «first-line» (UNLABELLED)
...
- **UNLABELLED** — «…cribe a patient with EML4-ALK-rearranged stage IIIB MPM who was administered with alectinib and lorlatinib as first-line and fourth-line therapy, respectively. He had remarkable response evaluated as partial response on both regim…»
- **UNLABELLED** — «…ctinib and lorlatinib, remain unexplored. In this case report, we describe a patient with EML4-ALK-rearranged stage IIIB MPM who was administered with alectinib and lorlatinib as first-line and fourth-line therapy, respectively. H…»
- **UNLABELLED** — «…o anaplastic lymphoma kinase (ALK) inhibitors, including alectinib and lorlatinib, remain unexplored. In this case report, we describe a patient with EML4-ALK-rearranged stage IIIB MPM who was administered with alectinib and lorlat…»
