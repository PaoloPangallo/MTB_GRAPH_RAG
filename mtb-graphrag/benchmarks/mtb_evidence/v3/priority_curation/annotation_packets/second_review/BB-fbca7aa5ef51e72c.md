# Revisione BB-fbca7aa5ef51e72c — second_review
...
- **Tipi di pubblicazione:** Journal Article, Research Support, Non-U.S. Gov't
...
| --- | --- | --- | --- |
| `ES-V2-evidence-1846` |  | `candidate_not_determinable` | `unsupported_by_primary_source` |
| `ES-V2-evidence-1847` |  | `candidate_not_determinable` | `unsupported_by_primary_source` |
| `ES-V2-evidence-1851` | infigratinib | `candidate_not_determinable` | `unsupported_by_primary_source` |
| `ES-V2-evidence-1853` | infigratinib | `candidate_not_determinable` | `unsupported_by_primary_source` |
