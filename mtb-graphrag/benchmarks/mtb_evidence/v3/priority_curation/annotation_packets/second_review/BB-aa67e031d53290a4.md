# Revisione BB-aa67e031d53290a4 — second_review

## Fonte

- **Titolo:** Heterogeneity of genetic changes associated with acquired crizotinib resistance in ALK-rearranged lung cancer.
- **PMID:** 23344087
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/23344087/
- **Tipi di pubblicazione:** Clinical Trial, Phase I, Clinical Trial, Phase II, Journal Article, Research Support, Non-U.S. Gov't
...
| --- | --- | --- | --- |
| `ES-V2-evidence-765` | crizotinib | `candidate_ambiguous` | `direct_support` |
| `ES-V2-evidence-767` | crizotinib | `candidate_ambiguous` | `direct_support` |

## Rilevazioni automatiche

**Emesse come valore:**

- `evidence_design` = `preclinical_in_vitro` — «In vitro» (METHODS)
...
- **METHODS** — «…nib, and these patients were analyzed for ALK, EGFR, and KRAS mutations and ALK and EGFR gene amplifications. In vitro cytotoxicity of crizotinib and ALK downstream signals were compared between crizotinib-naive and -resistant N…»
