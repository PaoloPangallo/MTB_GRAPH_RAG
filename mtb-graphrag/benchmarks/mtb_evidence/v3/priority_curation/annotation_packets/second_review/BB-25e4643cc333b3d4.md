# Revisione BB-25e4643cc333b3d4 — second_review

## Fonte

- **Titolo:** Identification of a novel HIP1-ALK fusion variant in Non-Small-Cell Lung Cancer (NSCLC) and discovery of ALK I1171 (I1171N/S) mutations in two ALK-rearranged NSCLC patients with resistance to Alectinib.
- **PMID:** 25393796
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/25393796/
- **Tipi di pubblicazione:** Case Reports, Journal Article, Research Support, Non-U.S. Gov't
...
| --- | --- | --- | --- |
| `ES-V2-evidence-1483` | alectinib hydrochloride | `candidate_not_determinable` | `unsupported_by_primary_source` |
| `ES-V2-evidence-1484` | alectinib hydrochloride | `candidate_not_determinable` | `unsupported_by_primary_source` |
