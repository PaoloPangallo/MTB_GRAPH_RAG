# Revisione BB-568b7e4f621a021e — second_review
...
- **Tipi di pubblicazione:** Journal Article, Research Support, N.I.H., Extramural
...
| --- | --- | --- | --- |
| `ES-V2-evidence-32` | crizotinib | `candidate_valid` | `direct_support` |
| `ES-V2-evidence-33` | crizotinib | `candidate_valid` | `direct_support` |
