# Revisione BB-70dc8fd781e0513f — second_review

## Fonte

- **Titolo:** Anaplastic Lymphoma Kinase (ALK) Kinase Domain Mutation Following ALK Inhibitor(s) Failure in Advanced ALK Positive Non-Small-Cell Lung Cancer: Analysis and Literature Review.
- **PMID:** 27130468
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/27130468/
- **Tipi di pubblicazione:** Journal Article, Review
...
- `setting` ⇒ `advanced`? — «advanced» (BACKGROUND)
- `therapy_line` ⇒ `second line or later`? — «second-line» (CONCLUSIONS)
...
- **BACKGROUND** — «Secondary anaplastic lymphoma kinase (ALK) mutation may occur in patients with advanced ALK-positive non-small cell lung cancer treated with ALK inhibitors, but its nature is not well-known.»
- **CONCLUSIONS** — «…esistance to other ALK inhibitors. Re-biopsy for ALK mutation analysis might be suggested prior to choosing a second-line ALK inhibitor treatment.»
