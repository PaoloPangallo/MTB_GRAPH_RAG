# Revisione BB-a21103fb02a7b7e6 — second_review

## Fonte

- **Titolo:** Impact of EML4-ALK Variant on Resistance Mechanisms and Clinical Outcomes in ALK-Positive Lung Cancer.
- **PMID:** 29373100
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/29373100/
...
- `evidence_design` = `retrospective_study` — «retrospectively» (UNLABELLED)
...
- **UNLABELLED** — «Purpose Advanced anaplastic lymphoma kinase ( ALK) fusion-positive non-small-cell lung cancers (NSCLCs) are effectively treate…»
- **UNLABELLED** — «…h ALK-positive NSCLC with known ALK variants. ALK resistance mutations and clinical outcomes on ALK TKIs were retrospectively evaluated according to ALK variant. A Foundation Medicine data set of 577 patients with ALK-positive NSCLC wa…»
