# Revisione BB-9162967582fb2f6a — second_review

## Fonte

- **Titolo:** Tracking the Evolution of Resistance to ALK Tyrosine Kinase Inhibitors through Longitudinal Analysis of Circulating Tumor DNA.
- **PMID:** 29376144
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/29376144/
...
- `therapy_line` ⇒ `second line or later`? — «after progression on» (RESULTS)
...
- **RESULTS** — «…files were dependent on the specific TKI administered. ALK G1202R, the most frequent plasma mutation detected after progression on a second-generation TKI, was consistently suppressed during treatment with lorlatinib.»
