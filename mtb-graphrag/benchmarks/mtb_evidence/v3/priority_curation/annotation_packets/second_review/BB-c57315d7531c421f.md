# Revisione BB-c57315d7531c421f — second_review

## Fonte

- **Titolo:** EML4-ALK mutations in lung cancer that confer resistance to ALK inhibitors.
- **PMID:** 20979473
- **Locator:** https://pubmed.ncbi.nlm.nih.gov/20979473/
...
| --- | --- | --- | --- |
| `ES-V2-evidence-236` | crizotinib | `candidate_not_determinable` | `unsupported_by_primary_source` |
| `ES-V2-evidence-237` | crizotinib | `candidate_not_determinable` | `unsupported_by_primary_source` |
