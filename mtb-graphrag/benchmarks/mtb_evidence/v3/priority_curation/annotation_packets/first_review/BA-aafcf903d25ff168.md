# Revisione BA-aafcf903d25ff168 — first_review
...
- Marcatori di piu' bracci: compared with
...
| --- | --- | --- | --- |
| `ES-V2-evidence-4288` | crizotinib | `candidate_ambiguous` | `direct_support` |
| `ES-V2-evidence-764` | crizotinib | `candidate_ambiguous` | `direct_support` |
| `ES-V2-evidence-766` | crizotinib | `candidate_ambiguous` | `direct_support` |

## Rilevazioni automatiche

**Emesse come valore:**

- `evidence_design` = `preclinical_in_vitro` — «in vitro» (RESULTS)
...
- **RESULTS** — «…l mutation in the ALK domain, encoding a G1269A amino acid substitution that confers resistance to crizotinib in vitro, was identified in two of these cases. Two patients, one with a resistance mutation, exhibited new onset ALK…»
