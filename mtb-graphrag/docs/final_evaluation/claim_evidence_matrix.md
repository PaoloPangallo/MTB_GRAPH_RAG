...
| C5 | Il selector generalizza oltre il corpus di sviluppo | Independent SourceUnit grounding | `INDEPENDENT` | E3 · RQ2 | `HitRate@5` su 9 positivi **e** su 20, `Recall@10`, MRR | `rq2/selector_comparison.json` | il vantaggio sul best baseline persiste su entrambi i denominatori | N = 20, CI ampi; nessuna soglia dichiarabile a posteriori; questa è una valutazione offline del selector, non la prova di due stage LIVE indipendenti |
